                        ...
                        <div className="container">
                            <div className="row d-flex justify-content-between">
                                <div className="dlab-topbar-left">
                                    <ul>
                                        <li><i className="flaticon-phone-call m-r5"></i>+998 95 778 88 68</li>
                                        <li><i className="ti-location-pin m-r5"></i> Samarqand shahar Universitet Xiyoboni 56-uy</li>
                                    </ul>
                                </div>
                                <div className="dlab-topbar-right">
                                    <ul>
                                        <li><i className="ti-email m-r5"></i> fenixcompanyuz@gmail.com</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="container clearfix">
                                ...
                                <div className="header-nav navbar-collapse collapse myNavbar justify-content-end" id="navbarNavDropdown">
                                    <div className="logo-header mostion d-md-block d-lg-none">
                                        <Link to={'/'} className="dez-page"><img src={logo2} alt="" className='Logo2' /></Link>
                                    </div>
                                    <HeaderMenu />
                                </div>
                            </div>
